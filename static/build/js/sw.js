...
self.addEventListener("install", function (event) {
  event.waitUntil(caches.open("twoffline-static-v7").then(function (cache) {
    return cache.addAll(["/tweetdeck-prototype/", "/tweetdeck-prototype/static/build/css/all.css", "/tweetdeck-prototype/static/build/js/all.js", "/tweetdeck-prototype/static/img/sprite.svg", "/tweetdeck-prototype/static/img/spinner-bubbles.svg"]);
  }));
});

var RetryObject = function RetryObject(request) {
  this.request = request;
  this.retries = 0;
};

RetryObject.prototype.inc = function () {
  return new RetryObject(this.request.clone(), this.retries + 1);
};

var RetryQueue = function RetryQueue() {
  this.timeout = null;
  this.resetDelay();
  this.queue = new Heap({
    compar: function (a, b) {
...
RetryQueue.prototype.resetDelay = function () {
  this.delay = 200;
};

RetryQueue.prototype.run = function () {
  var _this = this;
...
RetryQueue.prototype.abort = function () {
...
RetryQueue.prototype.insert = function (request) {
